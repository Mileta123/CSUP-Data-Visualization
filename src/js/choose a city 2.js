    ...
    request.onreadystatechange=function() {
        ...
        '<div class="ostaliPodaci">'+
            ...
            '<div class="ostatakVrijeme">'+
                '<h3 id="oblacnost"><u>Cloudiness:   '+oblacnost+'%</u></h3>'+
            '</div>'+
            
            '<div class="ostatakVrijeme">'+
                '<h3 id="vlaznost"><u>Humidity:   '+vlaznostVazduha+'%</u></h3>'+
            '</div>'+
            
            '<div class="ostatakVrijeme">'+
                '<h3 id="pritisak"><u>Pressure:   '+pritisakVazduha+'</u> hPa</h3>'+
            '</div>'+
            
            '<div class="ostatakVrijeme">'+
                '<h3 id="brzina_vjetra"><u>Wind speed:   '+brzinaVjetra+'m\s</u></h3>'+
            '</div>'+
